...
class MeasurementsSelectionPage extends StatefulWidget {
  const MeasurementsSelectionPage({Key? key}) : super(key: key);

  @override
  State<MeasurementsSelectionPage> createState() => _MeasurementsSelectionPageState();
}

class _MeasurementsSelectionPageState extends State<MeasurementsSelectionPage> {
  late SharedPreferences _prefs;
  List<Category> size = [
    Category(name: '5 kg ', itemCount: 20,color: Color(0xFFFF7427)),
    Category(name: '8 kg', itemCount: 32,color:Colors.black),
    Category(name: '10 kg', itemCount: 12,color:Color(0xFFF61313)),
    Category(name: '12 kg', itemCount: 10,color:Color(0xFFA2FA4B)),
  ...
  Future<void> _initPrefs() async {
    ...
    _prefs.getStringList('selectedMeasurements');
  ...
  Future<void> _saveSelectedCategories() async {
    ...
    await _prefs.remove('selectedMeasurements');
    ...
    final List<String> selectedCategoryNames = size
        ...
        .toList();
    await _prefs.setStringList('selectedMeasurements', selectedCategoryNames);
    Navigator.push(
      context,
      MaterialPageRoute(
