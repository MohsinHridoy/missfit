...
//     });
//
//     // Pause the current exercise's video
...
//         // Start countdown timer for 45 seconds
...
//             });
//
//             // Resume video for the next exercise if not skipped
...
//                   _isRestDialogVisible = false;
//                 });
//                 _nextItem(); // Start the next exercise video immediately
//                 _workoutItems[_currentIndex].controller!.play();
//               },
//             ),
//           ],
...
//       _startTimer();
//
//       // If not in rest dialog, start the video for the next item immediately
//       if (!_isRestDialogVisible) {
//         _workoutItems[_currentIndex].controller!.play();
//       } else {
//         // Pause the video if rest dialog is visible
//         _workoutItems[_currentIndex].controller!.pause();
//       }
//
//       // Calculate the scroll offset based on the index of the current exercise
