...
class ColourSelectionPage1 extends StatefulWidget {
  const ColourSelectionPage1({Key? key}) : super(key: key);

  @override
  State<ColourSelectionPage1> createState() => _ColourSelectionPage1State();
}

class _ColourSelectionPage1State extends State<ColourSelectionPage1> {
  ...
  Future<void> _initPrefs() async {
    ...
    _prefs.getStringList('selectedColours');
  ...
  Future<void> _saveSelectedCategories() async {
    ...
    await _prefs.remove('selectedColours');
    ...
    final List<String> selectedCategoryNames = size
        ...
        .toList();
    await _prefs.setStringList('selectedColours', selectedCategoryNames);
    Navigator.push(
      context,
      MaterialPageRoute(
