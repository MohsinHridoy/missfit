...
class ReviewSelectionPage extends StatefulWidget {
  const ReviewSelectionPage({Key? key}) : super(key: key);
...
class _ReviewSelectionPageState extends State<ReviewSelectionPage> {
  ...
  List<Category> size = [
    ...
    Category(name: '4', itemCount: 32,color:Colors.black),
    Category(name: '3', itemCount: 12,color:Color(0xFFF61313)),
    Category(name: '2', itemCount: 10,color:Color(0xFFA2FA4B)),
    Category(name: '1', itemCount: 12,color:Color(0xFF9923F5)),
  ...
  Future<void> _initPrefs() async {
    ...
    _prefs.getStringList('selectedReview');
  ...
  Future<void> _saveSelectedCategories() async {
    ...
    await _prefs.remove('selectedReview');
    ...
    final List<String> selectedCategoryNames = size
        ...
        .toList();
    await _prefs.setStringList('selectedReview', selectedCategoryNames);
    Navigator.push(
      context,
      MaterialPageRoute(
